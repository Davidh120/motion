...
import logoMotion from '../../assets/svg/Logo_motion.svg'
import enlist from '../../assets/img/Enlist.png'
import opco from '../../assets/img/opco.png'
import passanger from '../../assets/img/passenger.png'
import miSim from '../../assets/img/mi-sim.png'
import fuec from '../../assets/img/fuec.png'
import smartPhone from '../../assets/svg/Telefono.svg'
      ...
      <div className="container">
        ...
        <div className="main-content" ref={containerRef}>
          <div className="somos" ref={section1Ref}>
            <h2>Somos</h2>
            <img src={logoMotion} alt="content-logo" />
          ...
          <div className="desarrollos" ref={section2Ref}>
            ...
            <div className="apps">
              ...
              <div className="image">
                <img src={passanger} alt="passenger" />
