      ...
      <div className="container">
        ...
        <div className="main-content" ref={containerRef}>
          <div className="somos" ref={section1Ref}>
            <h2>Somos</h2>
            <img src="/assets/svg/Logo_motion.svg" alt="content-logo" />
          ...
          <div className="desarrollos" ref={section2Ref}>
            ...
            <div className="apps">
              <div className="image">
                <img src="/assets/img/Enlist.png" alt="Enlist" />
              ...
              <div className="image">
                <img src="/assets/img/opco.png" alt="Opcp" />
              ...
              <div className="image">
                <img src="/assets/img/passenger.png" alt="passenger" />
              ...
              <div className="image">
                <img src="/assets/img/fuec.png" alt="fuec" />
              ...
              <div className="image">
                <img src="/assets/img/mi-sim.png" alt="mi sim" />
        ...
        <div className="phone-content">
          ...
          <img src="/assets/svg/Telefono.svg" alt="Phone" />
        </div>
      </div>
    </section>
  )
